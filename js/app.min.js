...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Harri Soini"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Harri Soini</td></tr>
					<tr><td>Profession</td><td>Full Stack Developer</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Portfolio</td><td><a href="https://dynamic-medovik-c0bcab.netlify.app" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:beimax45621@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="https://join.skype.com/live:.cid.e956bdb96997ca9b"><i class="fab fa-skype"></i></a>
              <a href="https://t.me/@harrisoini"><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/beimax45621" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
          <tr><td>Resume</td><td><a href="/resume/HarriSoini.pdf" download>Download Resume</a></td></tr>
				</tbody>
			</table>
		</div>`,
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Harri Soini Facial Recognition">
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Harri" -lastName "Soini"',
        typing: true,
      },
      {
        text: "loading...",
